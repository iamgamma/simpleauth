 ...
 public class LoginFailedPacket
 {
   ...
   public static void handle(LoginFailedPacket packet, Supplier<NetworkEvent.Context> ctx) {
     ((NetworkEvent.Context)ctx.get()).enqueueWork(() -> DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> ClientPacketHandler.onLoginFailed(packet.reason, packet.countdownSeconds)));
...
/* Location:              /mnt/worker/simpleauth-5.0.0.jar!/com/zonoikk/simpleauth/network/packets/LoginFailedPacket.class
