           ...
           .then(Commands.argument("confirm", (ArgumentType)StringArgumentType.string())
             .executes(ctx -> {
                 ...
                 if (!password.equals(confirm)) {
                   ((CommandSourceStack)ctx.getSource()).sendFailure((Component)Component.literal(SimpleAuth.colorize(mod.getLocalizedMessage("password_mismatch", new Object[0]), "red")));
                   return 0;
                 } 
                 String username = player.getGameProfile().getName();
                 if (DatabaseManager.isUserRegistered(username)) {
                   ((CommandSourceStack)ctx.getSource()).sendFailure((Component)Component.literal(SimpleAuth.colorize(mod.getLocalizedMessage("already_registered", new Object[0]), "red")));
                   return 0;
                 } 
                 ...
                 ((CommandSourceStack)ctx.getSource()).sendFailure((Component)Component.literal(SimpleAuth.colorize(mod.getLocalizedMessage("registration_failed", new Object[0]), "red")));
                 return 0;
               }))));
   }
     ...
     dispatcher.register(
         ...
         .then(Commands.argument("password", (ArgumentType)StringArgumentType.string())
           .executes(ctx -> {
               ...
               String username = player.getGameProfile().getName();
               if (!DatabaseManager.isUserRegistered(username)) {
                 ((CommandSourceStack)ctx.getSource()).sendFailure((Component)Component.literal(SimpleAuth.colorize(mod.getLocalizedMessage("not_registered", new Object[0]), "red")));
                 return 0;
               } 
               ...
               switch (result) {
                 case SUCCESS:
                   ...
                   return 1;
                 case RATE_LIMITED:
                   ((CommandSourceStack)ctx.getSource()).sendFailure((Component)Component.literal(SimpleAuth.colorize(mod.getLocalizedMessage("too_many_attempts", new Object[0]), "red")));
                   return 0;
               } 
               ((CommandSourceStack)ctx.getSource()).sendFailure((Component)Component.literal(SimpleAuth.colorize(mod.getLocalizedMessage("incorrect_password", new Object[0]), "red")));
               return 0;
             })));
   }
             ...
             .then(Commands.argument("confirm", (ArgumentType)StringArgumentType.string())
               .executes(ctx -> {
                   ...
                   if (!((Boolean)mod.getPlayerSessionStatus().getOrDefault(player.getUUID(), Boolean.valueOf(false))).booleanValue()) {
                     ((CommandSourceStack)ctx.getSource()).sendFailure((Component)Component.literal(SimpleAuth.colorize(mod.getLocalizedMessage("must_be_logged_in", new Object[0]), "red")));
                     return 0;
                   } 
                   ...
                   if (result != AuthResult.SUCCESS) {
                     ((CommandSourceStack)ctx.getSource()).sendFailure((Component)Component.literal(SimpleAuth.colorize(mod.getLocalizedMessage("incorrect_old_password", new Object[0]), "red")));
                     return 0;
                   } 
                   ...
                   ((CommandSourceStack)ctx.getSource()).sendFailure((Component)Component.literal(SimpleAuth.colorize(mod.getLocalizedMessage("password_change_failed", new Object[0]), "red")));
                   return 0;
                 })))));
   }
           ...
           .then(Commands.argument("language", (ArgumentType)StringArgumentType.word())
             .executes(ctx -> {
                 ...
                 if (!lang.matches("en|es|fr|ru|ua|pl")) {
                   ((CommandSourceStack)ctx.getSource()).sendFailure((Component)Component.literal(SimpleAuth.colorize(mod.getLocalizedMessage("invalid_language", new Object[0]), "red")));
                   return 0;
                 } 
           ...
           .then(Commands.argument("player", (ArgumentType)GameProfileArgument.gameProfile())
             .executes(ctx -> {
                 ...
                 for (GameProfile profile : profiles) {
                   ServerPlayer target = ((CommandSourceStack)ctx.getSource()).getServer().getPlayerList().getPlayer(profile.getId());
                   if (target != null) {
...
/* Location:              /mnt/worker/simpleauth-5.0.0.jar!/com/zonoikk/simpleauth/AuthCommands.class
